...
import { BoolExpression, MetaSolverStrategyAstType, ProblemAttribute, ProblemType, ProblemTypes, SolveProblem, Solver, SolverID, SolverSetting } from './generated/ast.js';
...
export class MetaSolverStrategyValidator {
    ...
    async checkSolver(solver: Solver, accept: ValidationAcceptor): Promise<void> {
        ...
        const problemTypeId = getProblemTypeBySolverId(solver.solverId);
        if (!problemTypeId) {
